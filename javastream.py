...
if __name__ == '__main__':
    ...
    p = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,
                                ...
                                This script uses as handler the included {repr(java.parsers.StreamPrinter.__name__)}. Take said handler as a template for your own {repr(java.handlers.entity.Handler.__name__)} to process Java entities according to your specific need.
                                """)
