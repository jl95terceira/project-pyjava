...
class Tests(unittest.TestCase): 
    ...
    def test_1(self):
        ...
        self.tr.r_attribute    (model.Attribute        (name='b1', type=model.Type('int')                                   , access=model.AccessModifiers.PRIVATE      , value=' 123'           , final =True))
        self.tr.r_attribute    (model.Attribute        (name='b2', type=model.Type('boolean')               , static=True                                               , value='   true'        , final =True))
